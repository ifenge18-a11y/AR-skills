...
`accounting-research-assistant` 是一个面向会计学、财务管理和公司金融研究的 Codex Skill。它用于辅助研究者完成从选题构思、文献综述、理论分析、实证设计、数据规划、代码实现到论文写作与修改的完整研究流程。

该 Skill 特别适合会计学术论文、A 股实证研究、审计研究、信息披露研究、财务报告质量研究、公司治理研究、ESG 与可持续披露研究、资本市场会计研究，以及论文修改、审稿意见回复和研究计划制定。

## 主要功能

- 选题与研究问题提炼：将宽泛兴趣转化为可检验、可发表的研究问题。
- 文献综述与定位：构建中英文文献矩阵，识别理论张力、研究缺口和贡献边界。
...
- 论文写作与修改：辅助撰写摘要、引言、理论部分、研究设计、结果叙述、贡献表述和审稿回复。
...
该 Skill 支持半自动、合规的文献检索和 Zotero 导入流程。
